		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Mi título",
									"targetURL": "#esseidorcursopruebamanualj-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"esseidorcursopruebamanualj-display": {
								"semanticObject": "esseidorcursopruebamanualj",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=es.seidor.curso.pruebamanualj",
									"url": sap.ui.require.toUrl("es/seidor/curso/pruebamanualj")
								}
							}
						}
					}
